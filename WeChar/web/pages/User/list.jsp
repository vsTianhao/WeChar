		...
		<fieldset>
			...
			<table>
				<tr>	
					...
					<td>
						<input value="${query.password}" id="password" name="password" maxlength="100"  class=""/>
					</td>
				</tr>	
			</table>
		</fieldset>
		...
		<table width="100%"  border="0" cellspacing="0" class="gridBody">
		  ...
		  <tbody>
			  ...
			  <tr class="${status.count % 2 == 0 ? 'odd' : 'even'}">
				...
				<td><input type="checkbox" name="items" value="username=${item.username}&"></td>
				
				<td><c:out value='${item.password}'/>&nbsp;</td>
				<td>
					<a href="${ctx}/pages/User/show.do?username=${item.username}&">查看</a>&nbsp;&nbsp;&nbsp;
					<a href="${ctx}/pages/User/edit.do?username=${item.username}&">修改</a>
				</td>
			  </tr>
